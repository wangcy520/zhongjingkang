        ...
        >
          ...
          <el-form-item label="视训师识别码" prop="simpleCode">
            <el-input
              disabled
              type="text"
              placeholder="请输入视训师识别码"
              v-model="doctorForm.simpleCode"
            >
            </el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    headerclass({ row, column, rowIndex, columnIndex }) {
      if (this.columnIndex == 0 && columnIndex==4) {
        return "color:#409EFF";
      }else if(this.columnIndex == 1 && columnIndex==5){
         return "color:#409EFF"
      }else if(this.columnIndex == 2 && columnIndex==6){
         return "color:#409EFF"
      }else{
         return "color:#606266"
      }
